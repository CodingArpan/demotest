            ...
            <div className={styles.linkContainer}>
                ...
                <div className={styles.right}>
                    ...
                    <div className={styles.followSocials}>
                        ...
                        <Link href="https://www.facebook.com/codingarpan/"> <div className={styles.socialLink}>
                        ...
                        <Link href="https://www.instagram.com/codingarpan/"> <div className={styles.socialLink}>
                            <span className={styles.icon}>
                        ...
                        <Link href="https://www.linkedin.com/codingarpan">  <div className={styles.socialLink}>
                            <span className={styles.icon}>
                        ...
                        <Link href="https://twitter.com/codingarpan/"> <div className={styles.socialLink}>
                            <span className={styles.icon}>
                                <svg xmlns="http://www.w3.org/2000/svg" className={styles.socialIcons} viewBox="0 0 512 512">
