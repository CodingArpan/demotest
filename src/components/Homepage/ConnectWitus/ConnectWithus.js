...
import styles from '@/components/Homepage/ConnectWitus/ConnectWithus.module.css'
function ConnectWithus() {
    return (
        <div className="section connectwithus">
            <p className={`title`}>Connect With us</p>
            <div className={styles.socialContainer}>
                <div className={styles.twoConatiner}>
                    <Link href="https://www.facebook.com/MehDevClub/"> <div className={styles.socialCard}>
                        ...
                        <div className={styles.message}>
                            Follow the official Twitter Page of the
                            mehdevclub Community and stay updated.
                        </div>
                    </div></Link>
                    <Link href="https://twitter.com/MehDevClub/"><div className={styles.socialCard}>
                        <div className={styles.icon}>
                            <svg xmlns="http://www.w3.org/2000/svg" className={styles.socialIcons} viewBox="0 0 512 512">
                ...
                <div className={styles.twoConatiner}>
                    ...
                    <Link href="https://linkedin.com/company/mehdevclub"> <div className={styles.socialCard}>
                        <div className={styles.icon}>
                        ...
                        <div className={styles.message}>
                            Follow the official page of mehdevclub
                            Community where we regularly post about
                            all the upcoming workshops and events.
                        </div>
                    </div></Link>
                </div>
            </div>
