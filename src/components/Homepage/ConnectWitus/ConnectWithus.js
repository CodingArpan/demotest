        ...
        <div className="section connectwithus">
            ...
            <div className={styles.socialContainer}>
                <div className={styles.twoConatiner}>
                    <Link href="https://www.facebook.com/codingarpan/"> <div className={styles.socialCard}>
                    ...
                    <Link href="https://twitter.com/codingarpan/"><div className={styles.socialCard}>
                        <div className={styles.icon}>
                            <svg xmlns="http://www.w3.org/2000/svg" className={styles.socialIcons} viewBox="0 0 512 512">
                ...
                <div className={styles.twoConatiner}>
                    <Link href="https://www.instagram.com/codingarpan/"> <div className={styles.socialCard}>
                        <div className={styles.icon}>
                    ...
                    <Link href="https://linkedin.com/codingarpan"> <div className={styles.socialCard}>
                        <div className={styles.icon}>
